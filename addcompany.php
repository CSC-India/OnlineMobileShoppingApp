...
session_start();
   if(isset($_POST["submit"]))
   {
	 ...
	 $q="insert into companytable(company_name) values ('$n')";
	 mysql_query($q,$c);
	 $prt="<font color='red'>Company added Successfully</font>";
	 mysql_close($c);
...
<table width="902" height="390" align="center" cellpadding="0" cellspacing="0">
  <tr>
  ...
  <tr>
    <td height="233" colspan="7" ><img src="image/bannerforsite1.jpg" width="900" height="233" /></div></td>
  </tr>
    ...
    <td height="35" colspan="6"><table width="100%" height="65" border="0" align="center" cellpadding="0" cellspacing="0" >
      <tr>
        <td height="29" scope="col" ><p class="style14">&nbsp;</p>
            <p class="style14">ADD NEW COMPANY OR BRAND </p>
          <form id="form1" name="form1" method="post" action="">
              <table width="56%" border="0">
                <tr>
                  <td width="25%">New Company</td>
                  <td width="75%"><label>
