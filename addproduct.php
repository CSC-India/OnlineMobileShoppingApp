...
session_start();
   if(isset($_POST["submit"]))
   {
	 ...
	 mysql_query($q,$c);
	 $prt="<font color='red'>Product added Successfully</font>";
	 mysql_close($c);
...
<table width="920" height="392" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="27" colspan="7" align="right" >24x7 Customer service:+91-9872089188</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td width="150" height="35"><a href="showfeedback.php"><img src="image/v_feed.png" width="150" height="35" border="0" /></a></td>
    <td width="168" height="35"><a href="showquery.php"><img src="image/v_query.png" alt="1" width="150" height="35" border="0"/></a></td>
  </tr>
   <tr align="left">
