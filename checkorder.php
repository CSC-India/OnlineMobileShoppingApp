...
<table width="1002" height="335" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="8"><img src="image/bannerforsite.jpg" width="1000" height="233" /></td>
  </tr>
...
<tr  align="left">
  ...
  <tr>
    <th height="27" colspan="7" scope="col"><table width="100%" height="495" border="0" align="center" cellpadding="0" cellspacing="0" >
      <tr>
        <td width="13%" height="33" align="center" bgcolor="#A0A0A4"><span class="style14 style4"><strong>BRAND</strong></span></td>
        <td width="87%" rowspan="17" valign="top" scope="col" ><div align="left"><span class="style19"> <u></span></div>
            <p class="style14 style16"> Show Order Detail</p>
          <form action="showordertracking.php" method="get" enctype="multipart/form-data" name="form1" id="form1">
              <table width="44%" border="0">
                <tr>
                  <td width="42%"><span class="style11">Enter Order Number</span></td>
                  <td width="58%"><label>
