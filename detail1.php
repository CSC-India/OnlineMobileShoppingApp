...
<table width="1002" height="337" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="8"><img src="image/bannerforsite.jpg" width="1000" height="233" /></div></td>
  </tr>
  <?php
  if(isset($_SESSION["uname"]))
	{
...
<table width="75%" height="65" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr>
	...
	{
	print "<td><a href=deleteproduct.php?pid=$ans1[1] style='text-decoration:none'>Delete</a></td>";
	print "<td><a href=updateproduct.php?pid=$ans1[1] style='text-decoration:none'>Update</a></td>";
	}
	else
	{
	print "<td><a href=details.php?pid=$ans1[1] style='text-decoration:none'>Click here To See Detail</a></td>";
	}
		print "</tr>";
	 	 }
