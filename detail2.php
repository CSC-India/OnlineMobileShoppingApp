...
while($fetched = mysql_fetch_array($r1))
{
    ...
    echo "<td><a href=details.php?pid=".$fetched[1].">"."<img src=mobile/" . $fetched['image'] . " width=150px height=198px border=0 ></a>" ."<br />"."<center>" .$fetched[2]."<center>"."<br /><a href=details.php?pid=".$fetched[1]."><center>View Details</center></a></td>\n";
    $cols++;
    if($cols == $display)
    {
        echo "</tr>\n";
