...
if(isset($_POST["submit"]))
{
	...
	mysql_select_db("userdatabase") or die("error in database selection");
...
<table width="1002" height="324" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="233" colspan="8"><img src="image/bannerforsite.jpg" width="1005" height="233" /></td>
  </tr>
...
Average</label>
                ...
                <p>How do you came to know about Mobile-EStore?</p>
                <p>
                  <label>
...
Search Engine</label>
                ...
                <p>How do you compare our website with other mobile website?</p>
                <p>
                  <label>
...
What improvement you want in our Website? (Please write)</p>
  ...
  <textarea name="query" cols="45" rows="5" wrap="off"  id="query"></textarea>
                ...
                <p>Would You Like to Buy Mobile Accessories again from us . If we provide some more gift voucher ?</p>
                <p>
                  <label>
