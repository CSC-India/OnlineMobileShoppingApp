...
<table width="904" height="394" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr align="left">
	...
	if(isset($_SESSION["admin"]))
	{
	 ...
	 $r1=mysql_query($q,$c);
 	print "<table width=100% align='center' bgcolor='white' cellspacing='15'>";
	print "<tr>";
	print "<th  bgcolor='#ABCAE7'>OrderNo</th>";
	print "<th bgcolor='#ABCAE7'>UserId </th>";
	print "<th bgcolor='#ABCAE7'>Payment Mode</th>";
	print "<th bgcolor='#ABCAE7'>draft/cheque No </th>";
	print "<th bgcolor='#ABCAE7'>Shipping Address</th>";
	print "<th bgcolor='#ABCAE7'>order detail</th>";
	print "</tr>";
	  while($ans1=mysql_fetch_array($r1))
	 {
	 print "<tr>";
	 print "<td>$ans1[0]</td>";
	print "<td><a href=showcustomerdetail.php?uname=$ans1[1]>$ans1[1]</a></td>";
	 print "<td>$ans1[2]</td>";
     print "<td>$ans1[3]</td>";
	  print "<td>$ans1[5]</td>";
	  print "<td><a href=showorderdetail.php?sid=$ans1[4]>view order detail</a></td>";
