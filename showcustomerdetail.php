...
<table width="904" height="394" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr align="left">
    <td height="35" colspan="6"><table width="100%" height="65" border="0" align="center" cellpadding="0" cellspacing="0" >
      <tr>
        <td height="29" valign="top" scope="col" ><h2 class="style16">CUSTOMER DETAILS</h2>
            <?php
	if(isset($_SESSION["admin"]))
	{
	 ...
	 $q="select * from register where user_id='$a'";
	 $r1=mysql_query($q,$c);
	 
	
	print "<table width=800px align='center' bgcolor='white'>";
	print "<tr>";
	print "<td  bgcolor='#F2F5FC'>Name </td>";
	print "<td bgcolor='#F2F5FC'>Gender</td>";
	print "<td  bgcolor='#F2F5FC'>Email ID</td>";
	print "<td  bgcolor='#F2F5FC'>Phone</td>";
	print "<td  bgcolor='#F2F5FC'>Address</td>";
	print "</tr>";
	
	 while($ans1=mysql_fetch_array($r1))
	 {
	    print "<tr>";
		print "<td>$ans1[0] $ans1[1]</td>";
		print "<td>$ans1[2]</td>";
	 	print "<td>$ans1[6]</td>";
		print "<td>$ans1[7]	</td>";
		print "<td>$ans1[8]	</td>";
