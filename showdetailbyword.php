...
<table width="1002" height="337" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <th height="27" colspan="7" scope="col"><table width="100%" height="65" border="0" align="center" cellpadding="0" cellspacing="0" >
	 ...
	 $q="select * from producttable where feature like '%$f%'";
	 $r1=mysql_query($q,$c);
	 if(mysql_num_rows($r1)==0)
	 {
		print	 "<font color='red' > <h4 align='center'>Mobile with this feature Not Available</h$></font>";
	}
	else
	{
	print "<table width=800px align='center' bgcolor='white'>";
	print "<tr>";
	print "<td bgcolor='gray'>Name of Mobile </td>";
	print "<td  bgcolor='gray'>Price </td>";
	print "<td  bgcolor='gray'>Image </td>";
	print "<td bgcolor='gray'>Features</td>";
	print "</tr>";
	 ...
	 while($ans1=mysql_fetch_array($r1))
	 {
		...
		print "<td><a href=details.php?pid=$ans1[1]>Click here To See Detail</a></td>";
		print "</tr>";
	 	 }
