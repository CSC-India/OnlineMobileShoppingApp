...
<table width="904" height="394" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr align="left">
	...
	print "<th bgcolor='#ABCAE7'>Rating</th>";
	print "<th bgcolor='#ABCAE7'>Came to know?</th>";
	print "<th bgcolor='#ABCAE7'>Comparison</th>";
	print "<th bgcolor='#ABCAE7'>Additional suggestions</th>";
	print "<th bgcolor='#ABCAE7'>Buy Again</th>";
	print "<th bgcolor='#ABCAE7'>Delete</th>";
	print "</tr>";
	  while($ans1=mysql_fetch_array($r1))
	 {
	 print "<tr>";
	 print "<td>$ans1[1]  $ans1[2]</td>";
	print "<td>$ans1[3]</td>";
	 print "<td>$ans1[4]</td>";
     print "<td>$ans1[5]</td>";
	  print "<td>$ans1[6]</td>";
	  ...
	  print "<td>$ans1[8]</td>";
	  print "<td>$ans1[9]</td>";
	  print "<td><a href=deletefeedback.php?pid=$ans1[0] style='text-decoration:none'>Delete</a></td>";
	 }
	 print "</tr>";
	 print "</table>";
