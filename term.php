     ...
     <tr>
       ...
       <td width="84%" rowspan="17" valign="top" scope="col" ><p align="center" class="style5 style16 style17">TERMS &amp; CONDITION</p>
           ...
           <legend>TERMS &amp; CONDITION</legend>
             ...
             <div>
               <ol>
                 <li>Offer valid on all handsets above Rs.3000/- in value on a single bill only. Multiple handsets cannot be clubbed in one bill.</li>
                
                 <li>The cash back is instant and will be offered at the time of billing. Cash back cannot be claimed at a later date.</li>
                 <li>Cash back amount will be equal to or lower than the value of   the handset. In case the cash back amount is higher than the value of   the handset, customer will have to purchase a different product of the   cash back amount to avail the offer.</li>
                 <li>Additional coupon not available in case of DOA replacements/exchanges.</li>
                 <li>Tax liability on cash back is to be borne by the customer.</li>
               </ol>
             </div>
             </div>
           </fieldset></td>
