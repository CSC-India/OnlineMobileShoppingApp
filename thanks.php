...
session_start();
	if(!isset($_SESSION["uname"]))
		...
		$c=mysql_connect("localhost","root","") or die ("Error in connection");
		 ...
		 $r=mysql_query($q,$c);
		 while($ans1=mysql_fetch_array($r))
		 {
			$order=$ans1[0];
			$uname=$ans1[1];
			$paymode=$ans1[2];
...
<table width="1002" height="324" align="center" cellpadding="0" cellspacing="0">
 ...
 <tr  align="left">
   <th height="35" colspan="7" scope="col"><table width="100%" height="65" border="0" align="center" cellpadding="0" cellspacing="0" >
     <tr>
       <td height="29" valign="top" scope="col" ><p align="left" class="style10">Thanks for purchasing product from us , visit us again for more exciting new  mobile and we will provide you more exciting offer .............</p>
