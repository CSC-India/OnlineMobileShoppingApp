...
session_start();
   if(isset($_POST["submit"]))
   {
	 ...
	 $q="insert into accessorytype(type_of_accessory) values ('$n')";
	 mysql_query($q,$c);
	 $prt="<font color='red'>Accessory type added Successfully</font>";
	 mysql_close($c);
    ...
    <td height="35" colspan="6"><table width="100%" height="65" border="0" align="center" cellpadding="0" cellspacing="0" >
      <tr>
        <td height="29" scope="col" ><p class="style14">&nbsp;</p>
            <p class="style14">ADD Type of Accessory </p>
          <form id="form1" name="form1" method="post" action="">
              <table width="56%" border="0">
                <tr>
                  <td width="25%">New Accessory</td>
                  <td width="75%"><label>
